...
var AnnouncementKinya = _models["default"].AnnouncementKinya;
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return AnnouncementKinya.create(_objectSpread(_objectSpread({}, announcement), {}, {
                  createdAt: new Date(),
                  updatedAt: new Date()
                }), {
        ...
        return _regenerator["default"].wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return AnnouncementKinya.findOne({
  ...
  return _regenerator["default"].wrap(function _callee3$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return AnnouncementKinya.findAll();
    ...
    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return AnnouncementKinya.destroy({
              where: {
                id: id
              }
            });
    ...
    return _regenerator["default"].wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.next = 2;
            return AnnouncementKinya.update({
              title: newData.title,
