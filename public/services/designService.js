...
var DesignKinya = _models["default"].DesignKinya;
...
(0, _defineProperty2["default"])(DesignServices, "createDesign", /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(data) {
    var _yield$DesignKinya$cr, dataValues;
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return DesignKinya.create(_objectSpread(_objectSpread({}, data), {}, {
              createdAt: new Date(),
              updatedAt: new Date()
            }), {
          ...
          case 2:
            _yield$DesignKinya$cr = _context2.sent;
            dataValues = _yield$DesignKinya$cr.dataValues;
